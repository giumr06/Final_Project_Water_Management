...
show_pages(
    [
        Page("home.py", "Home", "🌊"),
        Page("./pages/cluster_2.py", "The Cluster Map", "🐋"),
...
if home_page == 'About us':
    ...
    st.markdown("  ")
    st.markdown("This project was proposed as the final project of the Data Science boot camp from Spiced Academy (10.2023).")
    st.markdown("<h5 style='text-align: center;'> Our main goals </h5>", unsafe_allow_html=True)
    st.markdown(
        """
    ...
    st.markdown("  ")
    st.markdown("<h5 style='text-align: center;'> Our main challenges </h5>", unsafe_allow_html=True)
    st.markdown(
            """
    ...
    st.markdown("  ")
    st.markdown("<h4 style='text-align: center;'>The Amwag Team  </h4>", unsafe_allow_html=True)
    st.markdown(
                 """                                                                                                                                                 
...
if home_page == 'The Project':
        ...
        with cent_2_co:
            ...
            st.markdown("    ")
        st.markdown("<h4 style='text-align: center;'> Understanding Global Water Stress </h4>", unsafe_allow_html=True)
        st.markdown(
           
            """
           Global water stress has emerged as a pivotal challenge that threatens lives and economies. This critical issue is characterized by the demand for water surpassing its availability, a trend that has seen a doubling of water demand since 1960. Various factors contribute to this increase in demand, including population growth, the needs of agriculture, energy production, and industry. Furthermore, inadequate investments in water infrastructure, unsustainable water policies, and the effects of the climate change on water supply further exacerbate the problem. \n
